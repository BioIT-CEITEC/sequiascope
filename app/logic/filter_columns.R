...
colnames_map_list <- function(tag, all_columns = NULL, session = NULL, tissues = NULL) {
  if (tag == "somatic"){
    ...
    map_list <- list(
      ...
      gnomad_afr = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD AFR"),
      gnomad_amr = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD AMR"),
      gnomad_eas = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD EAS"),
      gnomad_sas = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD SAS"),
      gnomad_fin = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD FIN"),
      gnomad_asj = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD ASJ"),
      gnomad_mid = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD MID"),
      gnomad_af  = colDef(minWidth = 140,maxWidth = 150,filterable = TRUE,name = "gnomAD AF"),
      `1000g_eur_af` = colDef(width = 130, name="1000G EUR AF"),
      `1000g_amr_af` = colDef(width = 130, name="1000G AMR AF"),
      `1000g_afr_af` = colDef(width = 130, name="1000G AFR AF"),
      `1000g_eas_af` = colDef(width = 130, name="1000G EAS AF"),
      `1000g_sas_af` = colDef(width = 130, name="1000G SAS AF"),
      `1000g_af`     = colDef(width = 130, name="1000G AF"),
