...
|                           | Deregulated genes for review                                                                     | Number of deregulated genes after applying filters: `|log2FC| > 2`, `FDR < 0.05`, `expression_level > 10 TPM`. **(Currently not implemented)** |
|                           | Altered pathways                                                                                | Number of altered pathways with `FDR < 0.05`. **(Currently not implemented)**                  |
