...
Exploration and visualization of somatic mutations in tumor samples

- **Required files**: 
  - `.tsv` | `.vcf` file with annotated variants (`.vcf` is not implemented yet)
...
Exploration and visualization of gene fusions from RNA-seq data
...
| Variant A                                | Variant B                                 |
|------------------------------------------|-------------------------------------------|
| <code>project_root/patient_001/<span style="font-weight:bold;">somatic</span>_variants.tsv</code> | <code>project_root/<span style="font-weight:bold;">somatic</span>_data/patient_001_variants.tsv</code> |
| <code>project_root/patient_001/<span style="font-weight:bold;">expression</span>.tsv</code> | <code>project_root/<span style="font-weight:bold;">RNAseq</span>/patient_001.tsv</code> |
